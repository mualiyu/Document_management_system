            ...
            <div class="d-flex align-items-center">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb m-0 p-0">
                        ...
                        <li class="breadcrumb-item">Review
                        </li>
                    </ol>
                </nav>
            </div>
    ...
    <div class="row mb-2">
        <div class="col-md-6 col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
            <form class="row g-3 needs-validation" method="POST"  action="{{route('share_store')}}" >
                @csrf
                    ...
                    <div class="table-responsive">
                        <table id="example" class="table table-striped">
                            ...
                            <tbody>
                                ...
                                @foreach ($data['documents'] as $dd)
                                <?php $d = \App\Models\Document::find($dd); ?>
                                <tr>
                                  <th scope="row">{{$i}}</th>
                                  <td>{{$d->name}}</td>
                                  {{-- <td>{{$d->url}}</td> --}}
